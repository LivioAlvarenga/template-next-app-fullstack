...
<p align="center">
  <a href= "https://"><img alt="deploy badge Vercel" height=40 src="https://raw.githubusercontent.com/LivioAlvarenga/LivioAlvarenga/fc06a7aa8d0f8ed5f446dcd83efd842e810d77df/files/vercel-badge.svg"></a>
<p>
...
"scripts": {
  ...
  "build": "prisma generate && next build", // Build production application
...
_Create **`.nvmrc`** file to specify NodeJs version_
...
npm install -D vite-tsconfig-paths # Install vite-tsconfig-paths to use tsconfig paths in vite
```
...
A acessibilidade é um dos pilares do desenvolvimento web. Por isso, é importante que o projeto seja acessível para todos os usuários. Para isso, utilizei o Radix UI para criar componentes acessíveis, como o ??????. Também me preocupei com uma paleta de cores que atendesse aos padrões de acessibilidade.

Utilizei tags semânticas além de boas praticas de uso dos atributos alt, title e aria-label.
...
- Uso de Radix UI para componentes com acessibilidade;
...
- Uso de Prisma para conectar com o banco de dados;
- Uso de Docker para criar um container com o banco de dados;
...
[Clique aqui para ver o ???? em ambiente de produção](https://)
